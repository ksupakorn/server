...
#define wsrep_thd_awake(T1,S) wsrep_service->wsrep_thd_awake_func(T,S)
...
#define wsrep_thd_set_wsrep_aborter(T1, T2) wsrep_service->wsrep_thd_set_wsrep_aborter_func(T1, T2)
